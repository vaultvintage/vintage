...
const DETAILS = [
  { name: "Vintage Savings", lede: "A convenient savings product, easy to maintain, with a competitive & attractive rate of return.", body: "£5,000 minimum deposit to open. Interest earned on every pound. A minimum balance of £5,000 must be maintained each day to avoid a monthly service charge of £25.00." },
  { name: "Wise Savings", lede: "A convenient savings product, easy to maintain, with a competitive rate of return.", body: "£50 minimum deposit to open. Interest earned on every pound. Service charges waived on custodial accounts until the minor reaches 18 years of age. A minimum balance of £500 must be maintained each day to avoid a monthly service charge of £5.00." },
  { name: "Premier Money Market", lede: "A high-yield solution to help you meet your goals while keeping your money liquid and available.", body: "No minimum deposit to open and no monthly service charges. Interest earned on every pound. No minimum balance to earn interest." },
  { name: "Vintage Money Market", lede: "A convenient savings product with a competitive rate of return — making your money work for you.", body: "£5,000 minimum deposit to open. Interest earned on every pound. A minimum balance of £5,000 must be maintained each day to avoid a monthly service charge of £25.00." },
